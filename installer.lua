...
local files                     = {
    {
        url  = "https://raw.githubusercontent.com/dan1707/oc_item_filter/master/item_filter.lua",
        path = "item_filter/main.lua"
    },
    {
        url  = "https://raw.githubusercontent.com/dan1707/oc_item_filter/master/transposer.lua",
        path = "item_filter/transposer.lua"
    },
    {
        url  = "https://raw.githubusercontent.com/rxi/json.lua/master/json.lua",
        path = "item_filter/json.lua"
    },
}
...
local properties                = {
    ...
    localization      = {
        ...
        finished1     = "Item Filter has been successfully installed",
...
local progressBarWidth = properties.windowWidth - properties.GUIElementsOffset * 2
